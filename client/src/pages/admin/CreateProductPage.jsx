...
const CreateProductPage = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            // Append images only if there are any
            if (images.length > 0) {
            ...
            await createProduct(formDataWithImages).unwrap();
                        ...
                        <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-4 sm:p-6 sticky top-6">
                            ...
                            <div className="mb-4">
                                <label className="flex flex-col items-center justify-center w-full border-2 border-dashed border-gray-300 rounded-lg cursor-pointer hover:border-blue-500 transition-colors bg-gray-50 hover:bg-gray-100 p-6">
                                    <div className="flex flex-col items-center gap-2">
                                        ...
                                        <p className="text-sm text-gray-600 font-medium">Upload Images</p>
                                ...
                                <div className="space-y-3">
                                    <div className="flex items-center justify-between">
                                        <p className="text-sm font-medium text-gray-700">
                                            {imagePreviews.length} image(s) uploaded
                                        </p>
                                        {imagePreviews.length > 0 && (
                                            <button
                                                type="button"
                            ...
                            {imagePreviews.length === 0 && (
                                <div className="text-center py-6">
                                    ...
                                    <p className="text-xs text-gray-400">Images are optional</p>
                                </div>
                            )}
                        </div>
                    </div>
